...
<h2>Contact Us</h2><br><br><br><hr>

	<div class="row">
	<div id="googleMap" style="width: 100%;background: yellow;position: relative;height: 400px;"></div>

<script>
function myMap() {
var mapOptions = {
    center: new google.maps.LatLng(6.8901429,79.911678),
    zoom: 10,
