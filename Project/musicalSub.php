...
<html>
<head>
	<title> Ticketmator | Musical </title>
<meta charset="utf-8">
  ...
  <a class="carousel-control-next" href="#carouselExampleFade" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
		...
		<br>
                ...
                <div class="row">
					<h1 style="text-align:center; margin-left: 40%;">Musical</h1>
				</div>
        ...
        <div class="container-fluid ">
                <div class="row ">                      
                        <div class="col mid1 indexz ">
                                <div class="card ">
                                        <img src="images/img2.jpg " alt="Avatar " width="300" height="200">
                                        <div class="container ">
                                                <h4>
                                                        Rs: 1500-5000/-<br>August 11<br>7.00 p.m<br>BMICH
                                                </h4>
                        ...
                        <div class="col mid2 indexz ">
                                <div class="card ">
                                        <img src="images/img3.png " alt="Avatar "  width="300" height="200">
                                        <div class="container ">
                                                <h4>
                                                        Rs: 1000-3000/-<br>August 26<br>6.00 p.m.<br>Sugathadasa Stadium
                                                </h4>
												<a  href="Buy.php"><button class="button" >BuyTicket</button></a>
                                        </div>
                                </div>
						...
						<div class="col mid2 indexz ">
								<div class="card ">
                                        <img src="images/img7.jpg " alt="Avatar "  width="300" height="200">
                                        <div class="container ">
                                                <h4>
                                                        Rs: 1500-5000/-<br>August 18<br>7.00 p.m<br>Bishop College Auditorium
                                                </h4>
												<a  href="Buy.php"><button class="button" >BuyTicket</button></a>
                                        </div>
                                </div>
