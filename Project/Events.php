  ...
  <a class="carousel-control-next" href="#carouselExampleFade" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
		...
		<br>
                ...
                <div class="row">
					<h1 style="text-align:center; margin-left: 40%;">Events</h1>
				</div>
        ...
        <div class="container-fluid ">
                <div class="row ">
                        <div class="col left indexz ">
                                <div class="card ">
                                        <a href="#"><img  src="images/events/m1.jpg " alt="Avatar "  width="300" height="200" ></a>
                                        <div class="container ">
                                                <h4>
                                                        Rs: 600/-<br> Monday - Saturday<br>1.30.p.m / 4.00.p.m<br>Savoy Cinema
                                                </h4>
												<a  href="Buy.php"><button class="button" >BuyTicket</button></a>
                                        </div>
                                </div>
                        </div>
                        <div class="col mid1 indexz ">
                                <div class="card ">
                                        <img src="images/events/m2.jpg " alt="Avatar " width="300" height="200">
                                        <div class="container ">
                                                <h4>
                                                         Rs: 600/-<br> Monday - Saturday<br>10.30.a.m / 1.30.p.m<br>Sky Light Cinema
                                                </h4>
												<a  href="Buy.php"><button class="button" >BuyTicket</button></a>
                                        </div>
                                </div>
                        </div>
                        <div class="col mid2 indexz ">
                                <div class="card ">
                                        <img src="images/events/m3.jpg " alt="Avatar "  width="300" height="200">
                                        <div class="container ">
                                                <h4>
                                                         Rs: 600/-<br> Monday - Saturday<br>1.00.p.m / 4.00.p.m<br>Savoy Cinema
                                                </h4>
												<a  href="Buy.php"><button class="button" >BuyTicket</button></a>
                                        </div>
                                </div>
                        </div>
                        <div class="col right indexz ">
                                <div class="card ">
                                        <img src="images/events/m4.jpg " alt="Avatar "  width="300" height="200">
                                        <div class="container ">
                                                <h4>
                                                         Rs: 600/-<br> Monday - Saturday<br>10.30.a.m / 4.30.p.m<br>Sky Light Cinema
                                                </h4>
												<a  href="Buy.php"><button class="button" >BuyTicket</button></a>
                                        </div>
                                </div>
...
<br><h1>Concert</h1><br>
        ...
        <div class="container-fluid ">
                <div class="row ">
                        <div class="col left indexz ">
                                <div class="card ">
                                        <img href="#" src="images/events/c1.jpg " alt="Avatar "  width="300" height="200">
                                        <div class="container ">
                                                <h4>
                                                     Ed Sheeran<br>Rs: 25,000/-<br>October 16<br>1.00.p.m<br>Bishop College Auditorium<br>
                                                </h4>
												<a  href="Buy.php"><button class="button" >BuyTicket</button></a>
                                        </div>
                                </div>
                        ...
                        <div class="col mid1 indexz ">
                                <div class="card ">
                                        <img src="images/events/c2.jpg" alt="Avatar "  width="300" height="200">
                                        <div class="container ">
                                                <h4>
                                                       Bruno mars<br>Rs: 50,000/-<br>19/08/2018<br>5.00.p.m<br>BMICH <br>
                                                </h4>
												<a  href="Buy.php"><button class="button" >BuyTicket</button></a>
                                        </div>
                                </div>
                        ...
                        <div class="col mid2 indexz ">
                                <div class="card ">
                                        <img src="images/events/c3.jpg " alt="Avatar "  width="300" height="200">
                                        <div class="container ">
                                                <h4>
                                                        Justin Bieber<br>Rs: 125,000/-<br>November 18<br>8.00.p.m<br>Sugathadasa Stadium<br>
                                                </h4>
												<a  href="Buy.php"><button class="button" >BuyTicket</button></a>
                                        </div>
                                </div>
                        ...
                        <div class="col right indexz ">
                                <div class="card ">
                                        <img src="images/events/c4.jpg " alt="Avatar "  width="300" height="200">
                                        <div class="container ">
                                                <h4>
                                                      Drake<br>Rs:325,000/-<br>December 24<br>10.00.p.m<br>Sugathadasa Stadium<br>
                                                </h4>
												<a  href="Buy.php"><button class="button" >BuyTicket</button></a>
                                        </div>
                                </div>
...
<br>
<br><br><h2> No Upcoming Sports Events.. </h2><br><br><br>
	<br>
