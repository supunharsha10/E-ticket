...
<html>
<head>
	<title> Ticketmator | Movies </title>
<meta charset="utf-8">
  ...
  <a class="carousel-control-next" href="#carouselExampleFade" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
		...
		<br>
                ...
                <div class="row">
					<h1 style="text-align:center; margin-left: 40%;">Movies</h1>
				</div>
        ...
        <div class="container-fluid ">
                <div class="row ">                                              
						<div class="col left indexz ">
                                <div class="card ">
                                        <a href="#"><img  src="images/img1.jpg " alt="Avatar "  width="300" height="200" ></a>
                                        <div class="container ">
                                                <h4>
                                                        Rs: 600/-<br> Monday - Saturday<br>01.30 p.m / 04.30 p.m<br>Savoy Cinema
                                                </h4>
						...
						<div class="col right indexz ">
                                <div class="card ">
                                        <img src="images/img4.jpg " alt="Avatar "  width="300" height="200">
                                        <div class="container ">
                                                <h4>
                                                        Rs: 600/-<br>Monday - Saturday<br>10.30 a.m / 01.30 p.m<br>Savoy Cinema
                                                </h4>
												<a  href="Buy.php"><button class="button" >BuyTicket</button></a>
                                        </div>
                                </div>
